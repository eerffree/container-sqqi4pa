...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-sqqi4pa.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-sqqi4pa.containers.anotherwebservice.com/
...
```
git clone git@github.com:eerffree/container-sqqi4pa.git
cd container-sqqi4pa
```
...
```
docker attach container-sqqi4pa
```
